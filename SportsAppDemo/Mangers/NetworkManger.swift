...
class FetchTeams{
    func fetchTeams(sport:String,leagueId:Int,complition:@escaping (Teams?)->Void){
        ...
        let url = URL(string: "https://apiv2.allsportsapi.com/\(sport)/?&met=Standings&leagueId=\(leagueId)&APIkey=948dffee8d69a2f1394c8afa15cf24ce972f8326f28d0e9270e26a9a24779b24&fbclid=IwAR2UWH0vmNLAOzK0ASZqx4VPJd_wpZ1BudOXucs4s4-DuXMmM_taOP3MDmw")
